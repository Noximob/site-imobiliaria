        ...
        <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <DynamicText path="footer.telefone" fallback="(47) 99753-0113" className="text-sm font-medium" />
            </div>

            {/* Redes Sociais */}
            <div className="flex items-center space-x-4">
              <DynamicText path="footer.texto_acompanhe" fallback="Acompanhe:" className="text-sm font-medium" />
          ...
          <div className="mt-8 pt-6 border-t border-gray-700">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 text-sm">
                <DynamicText path="footer.copyright" fallback="© 2024 Nox Imóveis. Todos os direitos reservados." />
              </p>
