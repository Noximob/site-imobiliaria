        ...
        <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <a 
                      ...
                      className="flex items-center space-x-2 mb-4 md:mb-0 hover:text-green-400 transition-colors"
                    >
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm font-medium">{textoAcompanhe}</span>
              <a href="https://www.instagram.com/noximoveis?igsh=cmVzYTFzNmZkNQ%3D%3D" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300 transition-colors" aria-label="Instagram">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://www.tiktok.com/@noximoveis?_r=1&_t=ZS-93IL19xyQDN" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300 transition-colors" aria-label="TikTok">
                <TikTokIcon className="w-5 h-5" />
              </a>
              <a href="https://www.facebook.com/share/1BtwHUDDAj/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300 transition-colors" aria-label="Facebook">
            ...
            <div className="text-center lg:text-right">
              ...
              <p className="text-gray-300 mb-2">{cidade}</p>
                      <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-purple-400 font-semibold hover:text-green-400 transition-colors"
                      >
                        {telefoneCentral}
                      </a>
            </div>
