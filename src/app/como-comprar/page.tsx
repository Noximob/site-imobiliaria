      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h2 className="text-blue-600 text-lg font-medium mb-2">Seu imóvel na praia</h2>
            ...
            <div className="relative group cursor-pointer">
              <div className="relative h-64 rounded-lg overflow-hidden">
                <div className="w-full h-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
                  <div className="text-center text-white/20">
                    <div className="text-4xl font-bold">FOTO PENHA</div>
                    <div className="text-sm mt-2">Aqui ficará a imagem de Penha</div>
                  </div>
                </div>
                <div className="absolute inset-0 bg-black bg-opacity-30 group-hover:bg-opacity-20 transition-all duration-300"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-white">
                    <div className="text-sm font-medium mb-1">Imóveis em</div>
                    <div className="text-2xl font-bold">Penha</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative group cursor-pointer">
              <div className="relative h-64 rounded-lg overflow-hidden">
                <div className="w-full h-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
                  <div className="text-center text-white/20">
                    <div className="text-4xl font-bold">FOTO PIÇARRAS</div>
                    <div className="text-sm mt-2">Aqui ficará a imagem de Piçarras</div>
                  </div>
                </div>
                <div className="absolute inset-0 bg-black bg-opacity-30 group-hover:bg-opacity-20 transition-all duration-300"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-white">
                    <div className="text-sm font-medium mb-1">Imóveis em</div>
                    <div className="text-2xl font-bold">Balneário Piçarras</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative group cursor-pointer">
              <div className="relative h-64 rounded-lg overflow-hidden">
                <div className="w-full h-full bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center">
                  <div className="text-center text-white/20">
                    <div className="text-4xl font-bold">FOTO BARRA VELHA</div>
                    <div className="text-sm mt-2">Aqui ficará a imagem de Barra Velha</div>
                  </div>
                </div>
                <div className="absolute inset-0 bg-black bg-opacity-30 group-hover:bg-opacity-20 transition-all duration-300"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-white">
                    <div className="text-sm font-medium mb-1">Imóveis em</div>
                    <div className="text-2xl font-bold">Barra Velha</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="text-center">
            ...
            <a
              ...
              className="bg-green-500 hover:bg-green-600 text-black font-bold py-4 px-8 rounded-lg transition-colors inline-flex items-center text-lg"
            >
