            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-md">
                  Nossa equipe especializada está pronta para te ajudar a encontrar o imóvel perfeito para cada momento da sua vida.
                </p>
                ...
                <a
                  ...
                  className="inline-flex items-center space-x-3 bg-green-500 hover:bg-green-600 text-white font-bold py-5 px-10 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-5 p-4 rounded-xl hover:bg-purple-50 transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-lg">Atendimento exclusivo e dedicado para suas necessidades específicas</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-5 p-4 rounded-xl hover:bg-purple-50 transition-colors duration-300">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-2">Especialistas na região</h3>
                    <p className="text-gray-600 text-lg">Conhecemos cada detalhe de Penha, Piçarras e Barra Velha</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-5 p-4 rounded-xl hover:bg-purple-50 transition-colors duration-300">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-2">Visite sem sair de casa</h3>
                    <p className="text-gray-600 text-lg">Conheça o imóvel por videochamada em tempo real</p>
                  </div>
                </div>
              </div>
            </div>
