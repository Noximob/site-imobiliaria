        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="lg:pr-6">
              ...
              <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg flex items-center text-base transition-colors duration-300 shadow-lg">
            ...
            {/* Right Column - Black Square with Benefits Grid */}
            <div className="bg-black p-6 rounded-lg">
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-start">
                  <div className="w-5 h-5 bg-purple-500 rounded-full flex items-center justify-center mr-3 flex-shrink-0 mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-base font-semibold mb-1 text-white">Mercado imobiliário em crescimento</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-base font-semibold mb-1 text-white">Localização estratégica</h3>
                    <p className="text-gray-300 text-xs leading-relaxed">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-base font-semibold mb-1 text-white">Qualidade de Vida</h3>
                    <p className="text-gray-300 text-xs leading-relaxed">
                      Além do potencial econômico, Penha oferece uma qualidade de vida excepcional. Com infraestrutura de primeira classe, serviços públicos de alta qualidade e um ambiente seguro, é um lugar ideal para se viver e investir.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-base font-semibold mb-1 text-white">Turismo em Expansão</h3>
                    <p className="text-gray-300 text-xs leading-relaxed">
                      O turismo é a espinha dorsal da economia de Penha. A cidade recebe milhões de turistas todos os anos, o que cria uma ampla oportunidade para investimentos no setor de hospitalidade, como hotéis, resorts e serviços relacionados.
                    </p>
                  </div>
                </div>
              </div>
