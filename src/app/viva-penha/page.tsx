          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-3 text-white">Mercado imobiliário em crescimento</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-3 text-white">Localização estratégica</h3>
                  <p className="text-blue-200 text-sm leading-relaxed">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-3 text-white">Qualidade de Vida</h3>
                  <p className="text-blue-200 text-sm leading-relaxed">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-3 text-white">Turismo em Expansão</h3>
                  <p className="text-blue-200 text-sm leading-relaxed">
