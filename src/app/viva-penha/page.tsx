        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="lg:pr-8">
              ...
              <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-8 rounded-lg flex items-center text-lg transition-colors duration-300 shadow-lg">
            ...
            <div className="bg-black p-8 rounded-lg">
              <div className="grid grid-cols-2 gap-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2 text-white">Mercado imobiliário em crescimento</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2 text-white">Localização estratégica</h3>
                    <p className="text-gray-300 text-sm leading-relaxed">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2 text-white">Qualidade de Vida</h3>
                    <p className="text-gray-300 text-sm leading-relaxed">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2 text-white">Turismo em Expansão</h3>
                    <p className="text-gray-300 text-sm leading-relaxed">
