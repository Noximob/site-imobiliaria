          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-base text-gray-600 mb-6 leading-relaxed">
                Seja bem-vindo à deslumbrante cidade de Barra Velha, um dos destinos mais encantadores do Brasil. Com suas praias deslumbrantes, vida noturna animada e oportunidades de investimento incríveis, Barra Velha é o local perfeito para viver, visitar e investir.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-base text-gray-600 mb-6 leading-relaxed">
                Aproveite tudo o que Barra Velha tem a oferecer e viva o melhor da cidade!
              </p>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-xs leading-relaxed">
                      Barra Velha é um dos destinos turísticos mais procurados do Brasil, o que torna o mercado imobiliário da cidade extremamente atraente para investidores.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-xs leading-relaxed">
                      Além do potencial econômico, Barra Velha oferece uma qualidade de vida excepcional. Com infraestrutura de primeira classe, serviços públicos de alta qualidade e um ambiente seguro, é um lugar ideal para se viver e investir.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-xs leading-relaxed">
                      O turismo é a espinha dorsal da economia de Barra Velha. A cidade recebe milhões de turistas todos os anos, o que cria uma ampla oportunidade para investimentos no setor de hospitalidade, como hotéis, resorts e serviços relacionados.
                    </p>
                  </div>
                </div>
              </div>
