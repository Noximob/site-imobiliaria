            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-blue-200">
                    Além do potencial econômico, Barra Velha oferece uma qualidade de vida excepcional. Com infraestrutura de primeira classe, serviços públicos de alta qualidade e um ambiente seguro.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-blue-200">
                    O turismo é a espinha dorsal da economia de Barra Velha. A cidade recebe milhões de turistas todos os anos, criando amplas oportunidades para investimentos.
                  </p>
                </div>
              </div>
            </div>
