    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[70vh] flex items-start justify-start overflow-hidden bg-transparent">
        ...
        <div className="relative z-10 text-left pl-8 pt-16">
          ...
          <button 
            onClick={() => {
              const element = document.getElementById('vantagens-picarras')
              if (element) {
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <Link href="/imoveis?cidade=balneario-picarras" className="inline-block bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-5 rounded-lg text-sm transition-colors duration-300">
      ...
      <section id="vantagens-picarras" className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="lg:pr-6 flex flex-col items-center lg:items-start">
              ...
              <a 
                ...
                onClick={() => trackWhatsAppClick('viva_picarras')}
      ...
      <section className="py-8 bg-purple-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
            <Link href="/imoveis?cidade=balneario-picarras&frenteMar=true" className="bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-6 rounded-lg transition-colors inline-flex items-center justify-center text-sm shadow-lg hover:shadow-xl transform hover:scale-105">
              <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/imoveis?cidade=balneario-picarras&vistaMar=true" className="bg-purple-500 hover:bg-purple-600 text-white font-medium py-3 px-6 rounded-lg transition-colors inline-flex items-center justify-center text-sm shadow-lg hover:shadow-xl transform hover:scale-105">
              <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/imoveis?cidade=balneario-picarras" className="bg-purple-700 hover:bg-purple-800 text-white font-medium py-3 px-6 rounded-lg transition-colors inline-flex items-center justify-center text-sm shadow-lg hover:shadow-xl transform hover:scale-105">
              <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
              </svg>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="bg-gradient-to-br from-purple-500 to-purple-600 p-6">
                ...
                <Link href="/imoveis?cidade=balneario-picarras" className="inline-block bg-purple-700 hover:bg-purple-800 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm shadow-lg hover:shadow-xl transform hover:scale-105">
                  Buscar imóveis
                </Link>
              </div>
            </div>
